...
export const compareTwoObject = (object1: object = {}, object2: object = {}): boolean => {
...
export const ensureArray = (data: unknown): Array<any> => (Array.isArray(data) ? data : []);
...
export const parseBoolean = (val: unknown): boolean =>
  !val || val === 'false' || val === 'null' || val === 'undefined' || val === '0' ? false : true;
